...
@section('content')
                            ...
                            <div class="d-flex justify-content-between mb-3">
                                ...
                                <div class="d-flex gap-2">
                                    <a href="#" onclick="addItem()" data-bs-toggle="modal" data-bs-target="#addItemModal" class="btn btn-success"><i class="fas fa-plus"></i>
                                        &nbsp; Add Data</a>
                                    <form action="{{ asset('incoming-item/detail/' . $incomingItem->id) }}" method="get">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ asset('incoming-item/detail/' . $incomingItem->id) }}" id="addItemForm" method="post">
                        @csrf
                        <div class="mb-3">
    ...
    <div class="modal fade" id="editItemModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ asset('incoming-item/detail/' . $incomingItem->id . '/update') }}" id="editItemForm" method="post">
                        @csrf
                        @method('put')
                        <div class="mb-3">
                            <label for="item_id" class="form-label">Item</label>
    ...
    <script>
        function editItem(id) {
            $.ajax({
                url: "{{ asset('incoming-item/detail/' . $incomingItem->id . '/find') }}" + '/' + id,
                type: 'GET',
                success: function(response) {
                    $('#edit_quantity').val(response.quantity);
                    $('#editItemForm').attr('action', "{{ asset('incoming-item/detail/' . $incomingItem->id . '/update') }}" + '/' + id);
