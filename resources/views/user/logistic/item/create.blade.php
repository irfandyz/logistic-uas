            ...
            <div class="row">
                <div class="col-12">
                    <div class="card mb-4">
                        ...
                        <form action="{{ asset('item') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="quantity" value="{{ old('quantity') }}" name="quantity" required>
                                @error('quantity')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
